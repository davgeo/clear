...
This logging package provides command line utilities some additional
functionality on print output. These include:
...
* An Input method for getting user response from the command line
